...
public class SoulCampfireRecipe extends CustomRecipe {
    public SoulCampfireRecipe(CraftingBookCategory category) {
        super(category);
    }
    ...
    public ItemStack assemble(CraftingInput craftingInput, HolderLookup.Provider provider) {
        return new ItemStack(Items.SOUL_CAMPFIRE);
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return CWRecipes.SOUL_CAMPFIRE.get();
    }
    ...
    private boolean isSoulsand(ItemStack stack) {
        return stack.is(ItemTags.SOUL_FIRE_BASE_BLOCKS);
    }
