...
public class CWLecternRenderer<C extends LecternBlockEntity> implements BlockEntityRenderer<CWLecternBlockEntity> {
    ...
    @Override
    public void render(CWLecternBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
