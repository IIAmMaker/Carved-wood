...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        LargePlanksBlockItem(CWBlocks.OAK_PANELS);
        LargePlanksBlockItem(CWBlocks.SPRUCE_PANELS);
        LargePlanksBlockItem(CWBlocks.BIRCH_PANELS);
        LargePlanksBlockItem(CWBlocks.JUNGLE_PANELS);
        LargePlanksBlockItem(CWBlocks.ACACIA_PANELS);
        LargePlanksBlockItem(CWBlocks.DARK_OAK_PANELS);
        LargePlanksBlockItem(CWBlocks.MANGROVE_PANELS);
        LargePlanksBlockItem(CWBlocks.CHERRY_PANELS);
        LargePlanksBlockItem(CWBlocks.PALE_OAK_PANELS);
        LargePlanksBlockItem(CWBlocks.CRIMSON_PANELS);
        LargePlanksBlockItem(CWBlocks.WARPED_PANELS);
        LargePlanksBlockItem(CWBlocks.BAMBOO_PANELS);
        ...
        evenSimplerBlockItem(CWBlocks.CARVED_PALE_OAK_PLANKS);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_LANTERN);
        ...
        evenSimplerBlockItem(CWBlocks.OAK_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.SPRUCE_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.BIRCH_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.JUNGLE_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.ACACIA_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.DARK_OAK_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.MANGROVE_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.CHERRY_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.PALE_OAK_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.CRIMSON_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.WARPED_LANTERN_BLOCK);
        evenSimplerBlockItem(CWBlocks.BAMBOO_LANTERN_BLOCK);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_BOARDS);
        ...
        evenSimplerBlockItem(CWBlocks.SMOOTH_PALE_OAK_BOARDS);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_TILES);
        evenSimplerBlockItem(CWBlocks.CRIMSON_TILES);
        evenSimplerBlockItem(CWBlocks.WARPED_TILES);
        evenSimplerBlockItem(CWBlocks.BAMBOO_TILES);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_TILE_STAIRS);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_TILE_SLAB);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_MOSAIC);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_MOSAIC_STAIRS);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_MOSAIC_SLAB);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_PILLAR);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_LOG_BUNDLE);
        ...
        evenSimplerBlockItem(CWBlocks.STRIPPED_PALE_OAK_LOG_BUNDLE);
        ...
        evenSimplerBlockItem(CWBlocks.SPRUCE_CRAFTER);
        evenSimplerBlockItem(CWBlocks.BIRCH_CRAFTER);
        evenSimplerBlockItem(CWBlocks.JUNGLE_CRAFTER);
        evenSimplerBlockItem(CWBlocks.ACACIA_CRAFTER);
        evenSimplerBlockItem(CWBlocks.DARK_OAK_CRAFTER);
        evenSimplerBlockItem(CWBlocks.MANGROVE_CRAFTER);
        evenSimplerBlockItem(CWBlocks.CHERRY_CRAFTER);
        evenSimplerBlockItem(CWBlocks.PALE_OAK_CRAFTER);
        evenSimplerBlockItem(CWBlocks.CRIMSON_CRAFTER);
        evenSimplerBlockItem(CWBlocks.WARPED_CRAFTER);
        evenSimplerBlockItem(CWBlocks.BAMBOO_CRAFTER);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_CRAFTING_TABLE);
        ...
        simplerBlockItem(CWBlocks.PALE_OAK_LADDER);
        ...
        chestBlockItem(CWBlocks.PALE_OAK_CHEST);
        chestBlockItem(CWBlocks.TRAPPED_PALE_OAK_CHEST);
        ...
        BlockItem(CWBlocks.PALE_OAK_CAMPFIRE);
        ...
        BlockItem(CWBlocks.SOUL_PALE_OAK_CAMPFIRE);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_BARREL);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_BOOKSHELF);
        ...
        chiseledBookshelfBlockItem(CWBlocks.CHISELED_PALE_OAK_BOOKSHELF);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_LECTERN);
        ...
        evenSimplerBlockItem(CWBlocks.PALE_OAK_BEEHIVE);
