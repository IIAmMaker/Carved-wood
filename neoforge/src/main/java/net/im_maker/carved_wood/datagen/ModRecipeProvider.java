...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void LargePlanksRecipe (RecipeOutput output, String woodType) {
        Item ingredient = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + "_planks");
    ...
    private void woodenMosaicRecipe (RecipeOutput output, String woodType) {
        Item ingredient = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport",woodType + "_slab");
    ...
    private void woodenCampfiresRecipe (RecipeOutput output, String woodType) {
        ...
        Item ingredient0 = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + trunkType);
        Item ingredient1 = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + trunkWoodType);
    ...
    private void logBundlesRecipe (RecipeOutput output, String woodType) {
        ...
        Item ingredient = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport",woodType + trunkType);
    ...
    private void strippedLogBundlesRecipe (RecipeOutput output, String woodType) {
        ...
        Item ingredient = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport","stripped_" + woodType + trunkType);
        trunkType = trunkType == "_block" ? "" : trunkType;
    ...
    private void logsFromLogsBundlesRecipes (RecipeOutput output, String woodType) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport",woodType + (trunkType == "" ? "_block" : trunkType)), 1)
                .requires(ingredient)
                .group("logs")
                .unlockedBy(getHasName(ingredient), has(ingredient))
    ...
    private void strippedLogsFromStrippedLogBundlesRecipes (RecipeOutput output, String woodType) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport","stripped_" + woodType + (trunkType == "" ? "_block" : trunkType)), 1)
                .requires(ingredient)
                .group("log")
                .unlockedBy(getHasName(ingredient), has(ingredient))
    ...
    private void woodsFromLogsRecipes (RecipeOutput output, String woodType) {
        if (woodType != "bamboo") {
            ...
            Item ingredient = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + trunkType);
            Item result = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + barkType);
    ...
    private void strippedWoodsFromStrippedLogsRecipes (RecipeOutput output, String woodType) {
        if (woodType != "bamboo") {
            ...
            switch (woodType) {
                ...
                Item ingredient = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", "stripped_" + woodType + trunkType);
            Item result = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", "stripped_" + woodType + barkType);
            ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result, 5)
                    .pattern(" # ")
                    .pattern("###")
                    .pattern(" # ")
    ...
    private void woodenBarrels (RecipeOutput output, String woodType) {
        Item planks = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + "_planks");
        Item slab = item(!woodType.equals("pale_oak") ? "minecraft" : "vanillabackport", woodType + "_slab");
