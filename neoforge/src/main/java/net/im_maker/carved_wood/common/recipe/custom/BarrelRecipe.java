...
public class BarrelRecipe extends CustomRecipe {
    ...
    private boolean isPlanks(ItemStack stack) {
        return stack.is(ItemTags.PLANKS) && !stack.is(CWTags.Items.FLAG) && !(BuiltInRegistries.ITEM.getKey(stack.getItem())).toString().equals("vanillabackport:pale_oak_planks");
    }
}