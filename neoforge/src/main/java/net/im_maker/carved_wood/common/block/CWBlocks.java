...
public class CWBlocks {
    ...
    //Wooden Lantern
    public static final DeferredBlock<Block> OAK_LANTERN_BLOCK  = registryWoodenFuelBlock("oak_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> SPRUCE_LANTERN_BLOCK  = registryWoodenFuelBlock("spruce_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> BIRCH_LANTERN_BLOCK  = registryWoodenFuelBlock("birch_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> JUNGLE_LANTERN_BLOCK  = registryWoodenFuelBlock("jungle_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> ACACIA_LANTERN_BLOCK  = registryWoodenFuelBlock("acacia_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> DARK_OAK_LANTERN_BLOCK  = registryWoodenFuelBlock("dark_oak_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> MANGROVE_LANTERN_BLOCK  = registryWoodenFuelBlock("mangrove_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MANGROVE_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> CHERRY_LANTERN_BLOCK  = registryWoodenFuelBlock("cherry_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_PLANKS).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> PALE_OAK_LANTERN_BLOCK  = registryWoodenFuelBlock("pale_oak_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).mapColor(MapColor.QUARTZ).lightLevel(lightValue(15))));
    public static final DeferredBlock<Block> CRIMSON_LANTERN_BLOCK  = registryBlock("crimson_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_PLANKS).lightLevel(lightValue(15)),false));
    public static final DeferredBlock<Block> WARPED_LANTERN_BLOCK  = registryBlock("warped_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WARPED_PLANKS).lightLevel(lightValue(15)),false));
    public static final DeferredBlock<Block> BAMBOO_LANTERN_BLOCK  = registryWoodenFuelBlock("bamboo_lantern_block", () -> new CarvedPlanksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_PLANKS).lightLevel(lightValue(15))));
    //Wooden Tiles
