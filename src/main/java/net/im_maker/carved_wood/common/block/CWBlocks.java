...
public class CWBlocks {
    ...
    public static final RegistryObject<Block> OAK_TRAPPED_CHEST = registryChestBlock("oak_trapped_chest", () -> new CWTrappedChestBlock("oak", BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> SPRUCE_TRAPPED_CHEST = registryChestBlock("spruce_trapped_chest", () -> new CWTrappedChestBlock("spruce", BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> BIRCH_TRAPPED_CHEST = registryChestBlock("birch_trapped_chest", () -> new CWTrappedChestBlock("birch", BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> JUNGLE_TRAPPED_CHEST = registryChestBlock("jungle_trapped_chest", () -> new CWTrappedChestBlock("jungle", BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> ACACIA_TRAPPED_CHEST = registryChestBlock("acacia_trapped_chest", () -> new CWTrappedChestBlock("acacia", BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> DARK_OAK_TRAPPED_CHEST = registryChestBlock("dark_oak_trapped_chest", () -> new CWTrappedChestBlock("dark_oak", BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> MANGROVE_TRAPPED_CHEST = registryChestBlock("mangrove_trapped_chest", () -> new CWTrappedChestBlock("mangrove", BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> CHERRY_TRAPPED_CHEST = registryChestBlock("cherry_trapped_chest", () -> new CWTrappedChestBlock("cherry", BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS).strength(2.5f)), true, true);
    ...
    public static final RegistryObject<Block> CRIMSON_TRAPPED_CHEST = registryChestBlock("crimson_trapped_chest", () -> new CWTrappedChestBlock("crimson", BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).strength(2.5f)), true, false);
    ...
    public static final RegistryObject<Block> WARPED_TRAPPED_CHEST = registryChestBlock("warped_trapped_chest", () -> new CWTrappedChestBlock("warped", BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).strength(2.5f)), true, false);
    ...
    public static final RegistryObject<Block> BAMBOO_TRAPPED_CHEST = registryChestBlock("bamboo_trapped_chest", () -> new CWTrappedChestBlock("bamboo", BlockBehaviour.Properties.copy(Blocks.BAMBOO_PLANKS).strength(2.5f)), true, true);
    //Barrels
    ...
    public static final RegistryObject<Block> SPRUCE_CAMPFIRE = registryBlock("spruce_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.COLOR_BROWN)));
    public static final RegistryObject<Block> SPRUCE_SOUL_CAMPFIRE = registryBlock("spruce_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.COLOR_BROWN)));
    public static final RegistryObject<Block> BIRCH_CAMPFIRE = registryBlock("birch_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.QUARTZ)));
    public static final RegistryObject<Block> BIRCH_SOUL_CAMPFIRE = registryBlock("birch_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.QUARTZ)));
    public static final RegistryObject<Block> JUNGLE_CAMPFIRE = registryBlock("jungle_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.PODZOL)));
    public static final RegistryObject<Block> JUNGLE_SOUL_CAMPFIRE = registryBlock("jungle_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.PODZOL)));
    public static final RegistryObject<Block> ACACIA_CAMPFIRE = registryBlock("acacia_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.STONE)));
    public static final RegistryObject<Block> ACACIA_SOUL_CAMPFIRE = registryBlock("acacia_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.STONE)));
    public static final RegistryObject<Block> DARK_OAK_CAMPFIRE = registryBlock("dark_oak_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.COLOR_BROWN)));
    public static final RegistryObject<Block> DARK_OAK_SOUL_CAMPFIRE = registryBlock("dark_oak_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.COLOR_BROWN)));
    public static final RegistryObject<Block> MANGROVE_CAMPFIRE = registryBlock("mangrove_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.PODZOL)));
    public static final RegistryObject<Block> MANGROVE_SOUL_CAMPFIRE = registryBlock("mangrove_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.PODZOL)));
    public static final RegistryObject<Block> CHERRY_CAMPFIRE = registryBlock("cherry_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.TERRACOTTA_GRAY)));
    public static final RegistryObject<Block> CHERRY_SOUL_CAMPFIRE = registryBlock("cherry_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.TERRACOTTA_GRAY)));
    public static final RegistryObject<Block> CRIMSON_CAMPFIRE = registryBlock("crimson_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.CRIMSON_STEM)));
    public static final RegistryObject<Block> CRIMSON_SOUL_CAMPFIRE = registryBlock("crimson_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.CRIMSON_STEM)));
    public static final RegistryObject<Block> WARPED_CAMPFIRE = registryBlock("warped_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.WARPED_STEM)));
    public static final RegistryObject<Block> WARPED_SOUL_CAMPFIRE = registryBlock("warped_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.WARPED_STEM)));
    public static final RegistryObject<Block> BAMBOO_CAMPFIRE = registryBlock("bamboo_campfire", () -> new CWCampfireBlock(true, 1, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.PLANT)));
    public static final RegistryObject<Block> BAMBOO_SOUL_CAMPFIRE = registryBlock("bamboo_soul_campfire", () -> new CWCampfireBlock(false, 2, BlockBehaviour.Properties.copy(Blocks.CAMPFIRE).mapColor(MapColor.PLANT)));
    //Bookshelvs
