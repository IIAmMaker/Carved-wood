...
public class ModBlockStateProvider<T> extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        chestBlock(CWBlocks.OAK_TRAPPED_CHEST.get(), "oak");
        chestBlock(CWBlocks.SPRUCE_CHEST.get(), "spruce");
        chestBlock(CWBlocks.SPRUCE_TRAPPED_CHEST.get(), "spruce");
        chestBlock(CWBlocks.BIRCH_CHEST.get(), "birch");
        chestBlock(CWBlocks.BIRCH_TRAPPED_CHEST.get(), "birch");
        chestBlock(CWBlocks.JUNGLE_CHEST.get(), "jungle");
        chestBlock(CWBlocks.JUNGLE_TRAPPED_CHEST.get(), "jungle");
        chestBlock(CWBlocks.ACACIA_CHEST.get(), "acacia");
        chestBlock(CWBlocks.ACACIA_TRAPPED_CHEST.get(), "acacia");
        chestBlock(CWBlocks.DARK_OAK_CHEST.get(), "dark_oak");
        chestBlock(CWBlocks.DARK_OAK_TRAPPED_CHEST.get(), "dark_oak");
        chestBlock(CWBlocks.MANGROVE_CHEST.get(), "mangrove");
        chestBlock(CWBlocks.MANGROVE_TRAPPED_CHEST.get(), "mangrove");
        chestBlock(CWBlocks.CHERRY_CHEST.get(), "cherry");
        chestBlock(CWBlocks.CHERRY_TRAPPED_CHEST.get(), "cherry");
        chestBlock(CWBlocks.CRIMSON_CHEST.get(), "crimson");
        chestBlock(CWBlocks.CRIMSON_TRAPPED_CHEST.get(), "crimson");
        chestBlock(CWBlocks.WARPED_CHEST.get(), "warped");
        chestBlock(CWBlocks.WARPED_TRAPPED_CHEST.get(), "warped");
        chestBlock(CWBlocks.BAMBOO_CHEST.get(), "bamboo");
        chestBlock(CWBlocks.BAMBOO_TRAPPED_CHEST.get(), "bamboo");
